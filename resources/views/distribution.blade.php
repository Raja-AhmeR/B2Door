...
<head>
    ...
    <title>B2Door Marketing - Distribution</title>
...
<body>
    ...
    <section id="hero">
        <div class="hero-container" data-aos="zoom-in" data-aos-delay="100">
            ...
            <a href="#order" class="about-btn scrollto">Distribution</a>
        </div>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row text-center">
                <div class="col-lg-12 col-md-12">
                    <a href="/register-distributor" class="order-btn btn scrollto">Register New Distributor</a>
                </div>
            </div>
            <br>
            <div class="table-responsive">
                <h3 class="text-center">Available Distributors</h3>
                <table class="table table-bordered table-hover table-striped text-center">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>10000</td>
                            <td><button class="btn btn-success">Invite</button> <button class="btn btn-danger">Block</button></td>
                        </tr>
                        <tr>
                            <th scope="row">2</th>
                            <td>Jacob</td>
                            ...
                            <td>I-9</td>
                            <td>10</td>
                            <td class="bg-danger">In-Active</td>
                            <td>9000</td>
                            <td><button class="btn btn-success">Invite</button> <button class="btn btn-warning">Un-Block</button></td>
                        </tr>
                        <tr>
                            <th scope="row">3</th>
                            <td>Larry</td>
